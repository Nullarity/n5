Procedure Make ()
	...
	|	case when Deductions.Deduction.Code = ""A"" then ""H""
	|		when Deductions.Deduction.Code = ""P"" then ""I""
...
Procedure O51 ()
	...
	result = get ( "H51" ) + get ( "I51" ) + get ( "J51" ) + get ( "K51" ) + get ( "L51" ) + get ( "M51" ) + get ( "N51" );

EndProcedure

Procedure O52 ()

	result = get ( "H52" ) + get ( "I52" ) + get ( "J52" ) + get ( "K52" ) + get ( "L52" ) + get ( "M52" ) + get ( "N52" );

EndProcedure

Procedure O53 ()

	result = get ( "H53" ) + get ( "I53" ) + get ( "J53" ) + get ( "K53" ) + get ( "L53" ) + get ( "M53" ) + get ( "N53" );

EndProcedure

Procedure O54 ()

	result = get ( "H54" ) + get ( "I54" ) + get ( "J54" ) + get ( "K54" ) + get ( "L54" ) + get ( "M54" ) + get ( "N54" );

EndProcedure

Procedure O55 ()

	result = get ( "H55" ) + get ( "I55" ) + get ( "J55" ) + get ( "K55" ) + get ( "L55" ) + get ( "M55" ) + get ( "N55" );

EndProcedure

Procedure O56 ()

	result = get ( "H56" ) + get ( "I56" ) + get ( "J56" ) + get ( "K56" ) + get ( "L56" ) + get ( "M56" ) + get ( "N56" );

EndProcedure

Procedure O57 ()

	result = get ( "H57" ) + get ( "I57" ) + get ( "J57" ) + get ( "K57" ) + get ( "L57" ) + get ( "M57" ) + get ( "N57" );

EndProcedure

Procedure O58 ()

	result = get ( "H58" ) + get ( "I58" ) + get ( "J58" ) + get ( "K58" ) + get ( "L58" ) + get ( "M58" ) + get ( "N58" );

EndProcedure

Procedure O59 ()

	result = get ( "H59" ) + get ( "I59" ) + get ( "J59" ) + get ( "K59" ) + get ( "L59" ) + get ( "M59" ) + get ( "N59" );

EndProcedure

Procedure O60 ()

	result = get ( "H60" ) + get ( "I60" ) + get ( "J60" ) + get ( "K60" ) + get ( "L60" ) + get ( "M60" ) + get ( "N60" );

EndProcedure

Procedure O61 ()

	result = get ( "H61" ) + get ( "I61" ) + get ( "J61" ) + get ( "K61" ) + get ( "L61" ) + get ( "M61" ) + get ( "N61" );

EndProcedure

Procedure O62 ()

	result = get ( "H62" ) + get ( "I62" ) + get ( "J62" ) + get ( "K62" ) + get ( "L62" ) + get ( "M62" ) + get ( "N62" );

EndProcedure

Procedure O63 ()

	result = get ( "H63" ) + get ( "I63" ) + get ( "J63" ) + get ( "K63" ) + get ( "L63" ) + get ( "M63" ) + get ( "N63" );

EndProcedure

Procedure O64 ()

	result = get ( "H64" ) + get ( "I64" ) + get ( "J64" ) + get ( "K64" ) + get ( "L64" ) + get ( "M64" ) + get ( "N64" );

EndProcedure

Procedure O65 ()

	result = get ( "H65" ) + get ( "I65" ) + get ( "J65" ) + get ( "K65" ) + get ( "L65" ) + get ( "M65" ) + get ( "N65" );

EndProcedure

Procedure O66 ()

	result = get ( "H66" ) + get ( "I66" ) + get ( "J66" ) + get ( "K66" ) + get ( "L66" ) + get ( "M66" ) + get ( "N66" );

EndProcedure

Procedure O67 ()

	result = get ( "H67" ) + get ( "I67" ) + get ( "J67" ) + get ( "K67" ) + get ( "L67" ) + get ( "M67" ) + get ( "N67" );

EndProcedure

Procedure O68 ()

	result = get ( "H68" ) + get ( "I68" ) + get ( "J68" ) + get ( "K68" ) + get ( "L68" ) + get ( "M68" ) + get ( "N68" );

EndProcedure

Procedure O69 ()

	result = get ( "H69" ) + get ( "I69" ) + get ( "J69" ) + get ( "K69" ) + get ( "L69" ) + get ( "M69" ) + get ( "N69" );

EndProcedure

Procedure O70 ()

	result = get ( "H70" ) + get ( "I70" ) + get ( "J70" ) + get ( "K70" ) + get ( "L70" ) + get ( "M70" ) + get ( "N70" );

EndProcedure

Procedure O71 ()

	result = get ( "H71" ) + get ( "I71" ) + get ( "J71" ) + get ( "K71" ) + get ( "L71" ) + get ( "M71" ) + get ( "N71" );

EndProcedure

Procedure O72 ()

	result = get ( "H72" ) + get ( "I72" ) + get ( "J72" ) + get ( "K72" ) + get ( "L72" ) + get ( "M72" ) + get ( "N72" );

EndProcedure

Procedure O73 ()

	result = get ( "H73" ) + get ( "I73" ) + get ( "J73" ) + get ( "K73" ) + get ( "L73" ) + get ( "M73" ) + get ( "N73" );

EndProcedure

Procedure O74 ()

	result = get ( "H74" ) + get ( "I74" ) + get ( "J74" ) + get ( "K74" ) + get ( "L74" ) + get ( "M74" ) + get ( "N74" );

EndProcedure

Procedure O75 ()

	result = get ( "H75" ) + get ( "I75" ) + get ( "J75" ) + get ( "K75" ) + get ( "L75" ) + get ( "M75" ) + get ( "N75" );

EndProcedure

Procedure O76 ()

	result = get ( "H76" ) + get ( "I76" ) + get ( "J76" ) + get ( "K76" ) + get ( "L76" ) + get ( "M76" ) + get ( "N76" );

EndProcedure

Procedure O77 ()

	result = get ( "H77" ) + get ( "I77" ) + get ( "J77" ) + get ( "K77" ) + get ( "L77" ) + get ( "M77" ) + get ( "N77" );

EndProcedure

Procedure O78 ()

	result = get ( "H78" ) + get ( "I78" ) + get ( "J78" ) + get ( "K78" ) + get ( "L78" ) + get ( "M78" ) + get ( "N78" );

EndProcedure

Procedure O79 ()

	result = get ( "H79" ) + get ( "I79" ) + get ( "J79" ) + get ( "K79" ) + get ( "L79" ) + get ( "M79" ) + get ( "N79" );

EndProcedure

Procedure O80 ()

	result = get ( "H80" ) + get ( "I80" ) + get ( "J80" ) + get ( "K80" ) + get ( "L80" ) + get ( "M80" ) + get ( "N80" );
