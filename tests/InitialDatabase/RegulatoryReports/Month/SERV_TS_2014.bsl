Procedure Make ()
	...
	|from AccountingRegister.General.Turnovers ( beginofperiod ( &DateEnd, month ), endofperiod ( &DateEnd, month ), , substring ( Account.Code, 1, 4 ) = ""6122"" 
	|			or substring ( Account.Code, 1, 3 ) = ""611"", , Company = &Company, ) as Turnovers
	|union all
	|select Turnovers.AmountTurnoverCr, ""Last""
	|from AccountingRegister.General.Turnovers ( beginofperiod ( &LastYearDateEnd, month ), endofperiod ( &LastYearDateEnd, month ), , substring ( Account.Code, 1, 4 ) = ""6122"" 
	|			or substring ( Account.Code, 1, 3 ) = ""611"", , Company = &Company, ) as Turnovers
	|";
	...
	FieldsValues [ "Period" ] = Format ( DateEnd, "L = 'ru_RU';DF='MMMM yyyy'" );
	
	assignField ( "A26", "Current", "Turnovers" );
	assignField ( "B26", "Last", "Turnovers" );
