...
id = Call ( "Common.ScenarioID", "2B6AC1E3" );
env = getEnv ( id );
createEnv ( env );
...
With ( list );
Set ( "#ReportField[R13C8:R13C27]", "Province: " + id );
Set ( "#ReportField[R16C5:R16C20]", "Street: " + id );
Set ( "#ReportField[R16C23:R16C27]", "Apartment: " + id );
Set ( "#ReportField[R25C10:R25C22]", "Owner type: " + id );
...
With ( list );
Set ( "#ReportField[R55C45:R55C57]", "100" );
Set ( "#ReportField[R62C58:R62C68]", "50" );
