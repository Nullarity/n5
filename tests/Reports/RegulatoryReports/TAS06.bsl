...
id = Call ( "Common.ScenarioID", "2A6C841F" );
env = getEnv ( id );
createEnv ( env );
...
Click ( "#ListCreate" );
With ( "Select Report" );
GotoRow ( "#List", "Description", "Использование местной символики" );
Click ( "#FormChoose" );
Pause ( __.Performance * 3 );
...
With ( list );
Set ( "#ReportField[R37C11:R37C15]", "2" );
...
With ( list );
Set ( "#ReportField[R37C1:R37C10]", "1000" );
Set ( "#ReportField[R37C21:R37C24]", "150" );
Set ( "#ReportField[R73C28:R73C33]", "250" );
Set ( "#ReportField[R75C28:R75C33]", "800" );
