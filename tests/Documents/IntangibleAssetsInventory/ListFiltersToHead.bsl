...
Call ( "Common.Init" );
CloseAll ();
form = Call ( "Common.OpenList", Meta.Documents.IntangibleAssetsInventory );

Choose ( "#DepartmentFilter" );
departmentName = "_Inventory Department";
...
employeeName = "_Inventory Employee2 " + Call ("Common.GetID");
params = Call ( "Common.Select.Params" );
...
With ( "Intangible Assets Inventory (create)" );
