...
MainWindow.ExecuteCommand ( "e1cib/list/Document.Commissioning" );
With ( "Commissionings" );
...
Click ( "#FormDocumentCommissioningCommissioning" );
With ( "Commissioning: Print" );
...
Function getEnv ()
	...
	id = Call ( "Common.ScenarioID", "282727DB#" );
	env = new Structure ();
	env.Insert ( "ID", id );
