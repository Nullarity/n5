...
- Конфигурацию можно использовать бесплатно, в ознакомительных целях. Никаких ограничений по функциональности при использовании такого режима, не накладывается.
- Приобрести легальную копию вы можете [здесь](https://cont.md/registration/config.php) или позвонив по телефону (373 22) 22-54-88. Изменение авторства разработки с целью перепродажи не допускается.
