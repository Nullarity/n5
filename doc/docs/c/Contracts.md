...
Справочная информация для произвольной классификации статусов договоров. В качестве примера могут выступать следующие значения: На ознакомлении, Отправлен, Ожидание подписи, Подшит и так далее. Статус выводится в форму списка договоров и может использоваться для отбора или сортировки данных.
