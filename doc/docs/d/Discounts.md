Документ предназначен для регистрации правил предоставления скидки за объём реализованных товаров. Объёмом считается сумма продаж в национальной валюте включая НДС, за минусом возвратов от покупателя.
