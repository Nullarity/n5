...
!!!tip "Совет"
	При отладке обработчиков, рекомендуется в настройках приложения, временно включить режим `Тестирование`, см. меню `Настройки / Система / Разработчик / Тестирование`. В этом режиме, выполнение загрузки не будет выполняться в фоновом режиме, что упростит анализ ошибочных ситуаций. Также, рекомендуется предварительно запустить программу из конфигуратора в режиме отладки, для получения сообщений об ошибках непосредственно в диалоге об ошибке.