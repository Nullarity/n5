...
Procedure BeforeClose ( Cancel, Exit, MessageText, StandardProcessing )
	...
	if ( SelectedValue = undefined ) then
		Cancel = true;
		pickValue ( Enum.ChoiceOperationsIntangibleAssetInProgress (), undefined );
	endif;
...
Procedure OK ( Command )
	...
	applyCommand ( Enum.ChoiceOperationsIntangibleAssetInProgress () );
...
Procedure SaveAndNew ( Command )
	...
	applyCommand ( Enum.ChoiceOperationsIntangibleAssetInProgressSaveAndNew () );
