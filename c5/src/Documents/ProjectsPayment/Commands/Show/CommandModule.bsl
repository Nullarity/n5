...
Procedure openList ( CommandParameter, CommandExecuteParameters )
	...
	OpenForm ( "Document.Payment.ListForm", p, CommandExecuteParameters.Source, CommandExecuteParameters.Uniqueness, CommandExecuteParameters.Window, CommandExecuteParameters.URL );
