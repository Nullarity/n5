...
Procedure calculate ()
	...
	payment = Object.Amount - Object.IncomeTaxAmount;
...
Procedure sqlBase ()
	...
	|	isnull ( VendorItems.Amount, 0 ) as Amount
	|from Document.VendorInvoice as Document
	|	//
	|	// Items
	|	//
	|	left join (
	|		select Items.Ref as Ref, sum ( Items.Total ) as Amount
	|		from Document.VendorInvoice.Items as Items
	|		where Items.Ref = &Base
	|		group by Items.Ref
	|	) as VendorItems
	|	on VendorItems.Ref = Document.Ref
...
Procedure AfterWrite ( WriteParameters )
	...
	Notify ( Enum.MessageItemsPurchaseIsSaved (), Object.Ref );	
