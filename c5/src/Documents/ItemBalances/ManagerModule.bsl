...
Procedure sqlWarehouse ( Env )
	...
	s = "
	|// #Items
	|select Goods.Item as Item, Goods.Feature as Feature, Goods.Warehouse as Warehouse,
	|	Goods.Package as Package, Goods.Series as Series, sum ( Goods.QuantityPkg ) as Quantity
	|from Items as Goods
