...
Procedure BeforeClose ( Cancel, Exit, MessageText, StandardProcessing )
	...
	if ( SelectedValue = undefined ) then
		Cancel = true;
		pickValue ( Enum.ChoiceOperationsPayEmployeesRecord (), undefined );
	endif;
...
Procedure OK ( Command )
	...
	applyCommand ( Enum.ChoiceOperationsPayEmployeesRecord () );
...
Procedure SaveAndNew ( Command )
	...
	applyCommand ( Enum.ChoiceOperationsPayEmployeesRecordSaveAndNew () );
